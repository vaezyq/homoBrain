...
详细的数学模型及推导过程见"20210612丁维洋老师关于组合优化问题的思考.pdf"
gurobi的使用方法参考
...
def draw_and_save(matrix, t, show_graph=False):
    ...
    fig_save_path = 'C:/all/WOW/brain/partition_and_route/new_graph/' + str(N) + '.png'
    plt.savefig(fig_save_path)

    txt_save_path = 'C:/all/WOW/brain/partition_and_route/new_graph/' + str(N) + '.txt'
